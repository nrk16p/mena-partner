...
DOC_RULES = [
    ...
    # ── แก้เลขข้อซ้ำจากต้นฉบับ (เปลี่ยนเฉพาะตัวเลข ไม่แตะถ้อยคำ) ──
    {"anchor": "กรณีผู้ซื้อประสงค์นำทรัพย์สินไปใช้", "find": "4.2กรณีผู้ซื้อประสงค์", "repl": "4.3กรณีผู้ซื้อประสงค์"},
    {"anchor": "เมื่อผู้ซื้อผิดนัดการชำระเงินดาวน์", "find": "5.1.2เมื่อผู้ซื้อผิดนัด", "repl": "5.1.1เมื่อผู้ซื้อผิดนัด"},
    {"anchor": "ให้อยู่ในบังคับและการตีความตามกฎหมายไทย", "find": "6.8สัญญาฉบับนี้", "repl": "6.9สัญญาฉบับนี้"},
    {"anchor": "มีผลใช้บังคับเหนือการตกลงใด", "find": "6.7คู่สัญญาตกลงว่า", "repl": "6.8คู่สัญญาตกลงว่า"},
    {"anchor": "จะต้องทำเป็นหนังสือ และลงลายมือชื่อโดยคู่สัญญาทุกฝ่าย", "find": "6.6การแก้ไขเพิ่มเติม", "repl": "6.7การแก้ไขเพิ่มเติม"},
    {"anchor": "มีผลบังคับใช้แยกต่างหากจากกัน", "find": "6.5ข้อกำหนดและเงื่อนไข", "repl": "6.6ข้อกำหนดและเงื่อนไข"},
    {"anchor": "จะมีหนังสือแจ้งที่อยู่ใหม่ให้ผู้ขายทราบ", "find": "6.4ผู้ซื้อสัญญาว่า", "repl": "6.5ผู้ซื้อสัญญาว่า"},
    {"anchor": "การแจ้งไปยังผู้ซื้อให้ทราบภาระการชำระหนี้", "find": "6.3การแจ้งไปยังผู้ซื้อ", "repl": "6.4การแจ้งไปยังผู้ซื้อ"},
]
