...
const STEPS: {
  ...
  },
  {
    ...
    wi: [
      "เข้าเมนู ค่าเที่ยว & เชื้อเพลิง → เลือกเดือน → กด \"ดึงจาก BI\" (ระบบกรอง รถร่วมมีนา + Mixer อัตโนมัติ)",
      "ตั้งค่าราคาน้ำมัน/เรตของเดือน (สืบทอดจากเดือนก่อน แก้เฉพาะที่เปลี่ยน)",
      "เทียบยอดรวมกับรายงานค่าเที่ยวของปฏิบัติการ — BI อาจช้ากว่าไฟล์ตัดยอด ให้ดึงซ้ำวันถัดไปจนนิ่ง",
    ],
    check: ["Σ ค่าเที่ยว ตรงรายงานปฏิบัติการ", "คนที่เที่ยว 0 แต่มีวันทำงาน → เช็คชื่อ/ทะเบียนเปลี่ยนคนขับ"],
